$(document).ready(function() {
	"use strict";
    if ($.fn.material_chip) { $('.chips').material_chip(); }
    if ($.fn.material_select) { $('select').material_select(); }
    ...
    if ($.fn.collapsible) { $('.collapsible').collapsible(); }
    ...
    if ($.fn.material_chip) { $('.chips-placeholder').material_chip({
        placeholder: 'Enter a tag',
        secondaryPlaceholder: '+Amini (press enter)',
    }); }

    //MATERIAL CHIP AUTO-COMPLETE
    if ($.fn.material_chip) { $('.chips-autocomplete').material_chip({
        autocompleteOptions: {
            data: {
                'Apple': null,
                'Microsoft': null,
